...
from app.blank_site import normalize_site, valid_site
...
def checked_site(raw: str) -> str:
    """两条写入路径共用：空串/纯空格拒绝 400，不生成替代名。"""
    if not valid_site(raw):
